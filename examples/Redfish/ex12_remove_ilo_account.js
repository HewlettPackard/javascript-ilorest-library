...
var ilo_loginname_to_remove = 'name';
...
client.login(USER, PASS)
	...
	.spread(function () {
		for (let res of arguments) {
			if (res.body['UserName'] == ilo_loginname_to_remove) {
				console.log('Remove iLO Account: ' + res.body['UserName']);
				return client.delete(res.body['@odata.id'])
					.catch((err) => {
						console.log('\n  Remove iLO Account Failed\n');
						throw err;
					});
			}
		}
