...
var PrimaryKeyServerAddress = '10.0.0.100';
var PrimaryKeyServerPort = '9000';
...
client.login(USER, PASS)
	...
	.then((res) => {
		console.log('EXAMPLE 37: Set ESKM Primary Key Server');
		var body = {};
		body['PrimaryKeyServerAddress'] = PrimaryKeyServerAddress;
		body['PrimaryKeyServerPort'] = PrimaryKeyServerPort;
