...
client.login(USER, PASS)
	...
	.then((res) => {
		if ('#HpESKM.TestESKMConnections' in res.body['Actions']) {
			var post_target = res.body['Actions']['#HpESKM.TestESKMConnections']['target'];
		}

		console.log('EXAMPLE 39: Test ESKM connection');
		var body = {};
