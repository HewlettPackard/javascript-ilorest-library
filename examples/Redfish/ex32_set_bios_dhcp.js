...
client.login(USER, PASS)
    ...
    .spread((registry, currentRBSU, nextRBSU) => {
        nextRBSU.Attributes.Ipv4Address = '192.168.0.1';
		nextRBSU.Attributes.Ipv4Gateway = '192.168.0.2';
		nextRBSU.Attributes.Ipv4PrimaryDNS = '192.168.0.3';
		nextRBSU.Attributes.Ipv4SecondaryDNS = '192.168.0.4';
		nextRBSU.Attributes.Ipv4SubnetMask = '192.168.0.5';
