...
client.login(USER, PASS)
	...
	.then((res) => {
		console.log('EXAMPLE 44: Dump LogicalDrivers details');
		if('ArrayControllers ' in res.body) {
			console.log('ArrayControllers: ' + res.body['ArrayControllers']);
		} else {
			console.log('ArrayControllers is not available on HpSmartStorageArrayController resoucre');
		}
	})
